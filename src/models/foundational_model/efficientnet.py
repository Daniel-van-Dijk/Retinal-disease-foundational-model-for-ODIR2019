...
from util.datasets_both import build_dataset, ODIRDataset, save_batch_images, TestDataset
...
from generate_predictions_csv_both import save_predictions
from engine_finetune_both import train_one_epoch, evaluate
from torch.utils.data import Dataset, DataLoader
from efficient import EfficientNetBaseline
...
def main(args):
    ...
    for idx, row in balanced_df.iterrows():
        left_img_name = os.path.join('/home/scur0594/ODIR2019/data/cropped_ODIR-5K_Training_Dataset', row['Left-Fundus'])
        right_img_name = os.path.join('/home/scur0594/ODIR2019/data/cropped_ODIR-5K_Training_Dataset', row['Right-Fundus'])
    ...
    dataset_train = ODIRDataset(train_df, '/home/scur0594/ODIR2019/data/cropped_ODIR-5K_Training_Dataset', is_train=True, args=args)
    dataset_val = ODIRDataset(validation_df, '/home/scur0594/ODIR2019/data/cropped_ODIR-5K_Training_Dataset', is_train=False, args=args)
    ...
    model = EfficientNetBaseline()#ODIRmodel(base_vit_model=base_vit_model, num_classes=args.nb_classes) 
    print('odir', model)
    ...
    #checkpoint = torch.load('/home/scur0594/ODIR2019/src/models/foundational_model/run4198210/best_model_checkpoint_fold_3.pth', map_location=device)
    checkpoint = torch.load('/home/scur0594/ODIR2019/src/models/foundational_model/run_4238331/best_score_checkpoint.pth', map_location = device)

    model.load_state_dict(checkpoint['model_state_dict'])
    model.eval()
    test_loader = DataLoader(TestDataset('/home/scur0594/ODIR2019/data/cropped_ODIR-5K_Testing_Dataset', is_train=False, args=args), batch_size=16, shuffle=False)
