...
def main(args):
    ...
    train_df, validation_df = train_test_split(balanced_df, test_size=0.2, random_state=datasetseed)
    ...
    max_increasing_epochs = 3  # Set the maximum number of consecutive increasing epochs for early stopping
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # Check if this is the best model so far based on final score
        if final_score > best_final_score and val_loss < 0.3:
