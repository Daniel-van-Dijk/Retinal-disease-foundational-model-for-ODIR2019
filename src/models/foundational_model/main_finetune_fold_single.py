...
def main(args, fold, mode, best_path, balanced_df):
    ...
    #balanced_df = pd.read_csv("/home/scur0594/ODIR2019/data/expanded sheet - merged.csv")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if final_score > best_final_score_per_fold and val_loss < 0.5:
            ...
            print("Model checkpoint saved at", checkpoint_path_per_fold)
