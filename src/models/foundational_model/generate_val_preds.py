...
def main(args):
    ...
    expanded_df = pd.read_csv("/home/scur0594/ODIR2019/data/expanded sheet - merged.csv")
    ...
    val_loader = Merge_valset(expanded_validation_df, '/home/scur0594/ODIR2019/data/cropped_ODIR-5K_Training_Dataset', is_train=False, args=args)
    ...
    checkpoint_path = '/home/scur0594/ODIR2019/src/models/foundational_model/run_4237493/best_model_checkpoint_fold_3.pth'
    ...
    save_combined_predictions(model, test_loader, device, 'saved_combined.csv', logit_output=True)
