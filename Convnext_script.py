...
validation_dataset = ODIRDataset(validation_df, 'data/ODIR-5K_Training_Dataset', transforms=val_transform)
...
class ConvNext(nn.Module):
    def __init__(self, num_diseases=8):
        ...
        self.resnet = models.ConvNeXt_Tiny_Weights(weights='DEFAULT')
        self.fc1 = nn.Linear(2 * 1000, 128)
        self.fc2 = nn.Linear(128, num_diseases)
